...
def main():
    ...
    parser.add_argument("--rate", type=int, default=1, help="Оценка отзыва")
    parser.add_argument("--csv_path", default="D:/AppProgPython/appprog/csv/2.csv.csv", help="Путь к файлу CSV")
