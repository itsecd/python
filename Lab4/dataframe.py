...
def create_dataframe(csv_path: str, csv_filename: str, tag: str) -> None:
    ...
    csv_file.to_csv(csv_filename,idx=False)
    print(csv_file)

if __name__=="__main__":
    with open('settings.json','r') as f:
        settings=json.load(f)
    create_dataframe(os.path.join(r'C:\Users\Yana\Documents\python-v6\Lab2', 'file.csv'), 'Lab4\data.csv', settings['tag_tiger'])
