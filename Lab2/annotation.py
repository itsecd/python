...
def get_annotation(directory='dataset', new_dir='new_dataset', label_annotation=AnnotationLabel.DEFAULT) -> Generator[
    list, None, None]:
    """
    ...
    # if (label_annotation != AnnotationLabel.DEFAULT):
    #     makedir(new_dir)
    # for star in range(1, 6):
