...
if __name__ == '__main__':
    ...
    if settings['mode'] == 'random_dataset':
        random_dataset.random_dataset(settings['main_dataset'],settings['dataset_random'],settings['default_number'],settings['classes'])
        create_annotation.create_annotation_file(settings['dataset_random'], settings['random_csv'])
